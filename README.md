...
* [**Great3Fun.java**](https://github.com/arman071122/javaCore/blob/main/Java/src/week2/Great3Fun.java) : Finds the greatest of three numbers using conditional statements and the bitwise AND operator to compare the values.
...
* [**numPalJava**](https://github.com/arman071122/javaCore/blob/main/Java/src/week3/numPalJava.java): Reads an integer from the user, reverses it, and checks if the original number is a palindrome.
